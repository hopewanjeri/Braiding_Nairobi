    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // iosstatusbarblackKnq (113:26)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 125*fem),
              width: 428*fem,
              height: 37*fem,
              child: Image.asset(
                'assets/page-1/images/ios-status-bar-black-Xp5.png',
                width: 428*fem,
                height: 37*fem,
              ),
            ),
            Container(
              // autogroupjgcrpzV (HUTK5xMbcKnwPhpRHbjgcR)
              ...
              decoration: BoxDecoration (
                image: DecorationImage (
                  fit: BoxFit.cover,
                  image: AssetImage (
                    'assets/page-1/images/n-1-1-bg-4Xs.png',
                  ),
                ),
              ),
              child: Align(
                // empoweringafricanhairbraidingo (112:12)
